...
def save_reports(violations):
    ...
    output_file = os.path.join(output_dir, "security_violations.md")

    with open(output_file, "w") as mdfile:
        mdfile.write("# PMD Security Violations\n\n")
...
if __name__ == "__main__":
    rules_file = "resources/pmd_rules/security.txt"
    reports_dir = ".."
    ...
    print("📁 Saved security_violations.md")
